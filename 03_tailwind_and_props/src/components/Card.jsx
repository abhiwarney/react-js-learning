//passing props in the arguments
function Card({username, btnTxt, other}) {
        ...
        <>
            <div className="m-4 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5">
                    ...
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are details of {username}, age: {other.age}, skill: {other.skill}</p>
